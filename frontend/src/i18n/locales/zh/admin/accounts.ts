export default {
    accounts: {
      ...
      openai: {
        ...
        codexTurnTicketEnabled: '启用 Codex 292 打票',
        codexTurnTicketEnabledDesc: '默认开启，仅在全局打票功能开启时生效。关闭后，此账号不再打票、注入门票或因缺票暂停调度。账号停调（手动、限流、过载、临时冷却或到期自动停调）期间暂停打票，恢复调度后自动继续。',
